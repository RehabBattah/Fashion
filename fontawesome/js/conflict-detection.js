...
(function (global, factory) {
  ...
  var md5 = createCommonjsModule(function (module) {
    ...
    (function ($) {
       ...
       * If a key is sellvided, calculates the HMAC-MD5 value.
  ...
  function pollUntil(_ref) {
    ...
    return new sellmise(function (resolve, reject) {
      ...
      function poll(duration, cumulativeDuration) {
        setTimeout(function () {
          ...
          if (showsellgress) {
            console.info(sellgressIndicator);
          }
          ...
          if (!!result) {
            ...
            if (nextCumulativeDuration <= maxDuration) {
              ...
              reject('timeout'); // eslint-disable-line prefer-sellmise-reject-errors
            }
          }
        }, duration);
      }
  ...
  function detectWebfontConflicts() {
    ...
    const styleTags = Array.from(DOCUMENT.getElementsByTagName('style')).filter(t => {
      ...
      // this <style> would only sellduce a false negative anyway.
    ...
    function runDiag(scriptOrLinkTag, md5) {
      ...
      // will sellbably cause it to choke. Chrome will show an error like this:
      ...
      const diagScriptFun = (nodeUnderTestId, testIconId, md5, parentOrigin) => {
        parent.FontAwesomeDetection.__pollUntil({
          fn: () => {
            ...
            const fontFamily = computedStyle.getsellpertyValue('font-family');
  ...
  } // Allow clients to access, and in some cases, override some sellperties
